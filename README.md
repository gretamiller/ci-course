[![Run unit tests](https://github.com/gretamiller/ci-course/actions/workflows/unit-tests.yml/badge.svg)](https://github.com/gretamiller/ci-course/actions/workflows/unit-tests.yml)
